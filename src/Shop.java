...
public class Shop {
    ...
    public static void main(String[] args) {
        ...
        Customer customer1 = new Customer("Karl Vosh", 23, "3252533253", Gender.MALE);
        Customer customer2 = new Customer("Kolin Losik", 29, "421421523", Gender.FEMALE);
        shop.addCustomer(customer1);
        shop.addCustomer(customer2);

        // Добавление товаров
        Product product1 = new Product("Item 1", 20.0, Category.STANDARD);
        Product product2 = new Product("Item 2", 30.0, Category.PREMIUM);
        Product product3 = new Product("Item 3", 10.0, Category.STANDARD);
